...
/**
 * Clase que implementa un iterador para recorrer una lista simplemente enlazada.
 *
 ...
 */
public class IteradorLSE<T> implements ContratoIterador<T>{
    /**
     * Referencia al nodo que está siendo apuntado actualmente por el iterador.
     */
    private ElementoSE<T> apuntado;
    /**
